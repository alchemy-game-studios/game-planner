...
import { LOGIN_MUTATION } from '../client-graphql/canon-operations';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#fff', marginBottom: 8, fontSize: 24 }}>🔥 Welcome Back</h2>
        <p style={{ color: '#6a6a8a', marginBottom: 24, fontSize: 14 }}>
          Sign in to your CanonKiln account
        </p>
